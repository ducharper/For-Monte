...
A C++ Monte Carlo engine for pricing European options. This project was built from the ground up with the purpose of aiding my learning of C++ and teaching me more about finance. 
...
Right now, the next big step for the project is implementing Giles' Multilevel Monte Carlo. Regular Monte Carlo is computationally inefficient, but MLMC addresses this through a variance-reduction technique combining simulations across multiple discretization levels.
